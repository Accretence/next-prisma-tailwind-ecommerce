...
export async function getCrossSellProducts(productId: string, limit?: number) {
   try {
      console.log(`[getCrossSellProducts] Looking for product: ${productId}`)
      ...
      console.log(`[getCrossSellProducts] Product found:`, product ? 'Yes' : 'No')
      console.log(`[getCrossSellProducts] Cross-sell products:`, product?.Product_A?.length || 0)
